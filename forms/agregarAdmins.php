...
if (isset($_SESSION['correo']) && $_SESSION['rol'] == 'root') {
        ...
        <div class="row">
                ...
                <section>
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <ul >
                            ...
                            <li role="presentation"><a href="agregarUsuarios.php" >Agregar usuarios</a></li>
            ...
            <article class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                <section class="col-lg-6">
                    ...
                    <form class="form-horizontal" action="../php/insertar.php?admon=1" method="POST">
                        
                        <div class="form-group">
                            <h2>Agrega un administrador nuevo</h2>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="tel" name="tel" class="form-control" id="inputTelefono" placeholder="Telefono">
                            </div>
                        </div>
