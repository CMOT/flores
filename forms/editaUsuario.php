        ...
        <div class="row">
            ...
            <article class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                <section class="col-lg-6">
                    <form class="form-horizontal" action="../php/actualizar.php?userAc=<?php echo $id; ?>" method="POST">
                        <div class="form-group">
                            <label for="inputNombre" class="col-sm-3 control-label">Primer nombre:</label>*
                            <div class="col-sm-9">
                                <input value="<?php echo $nom; ?>" type="text" name="nom" class="form-control" id="inputNombre" placeholder="Primer nombre">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputApPat" class="col-sm-3 control-label">Apellido paterno:</label>
                            <div class="col-sm-9">
                                <input value="<?php echo $apPat; ?>" type="text" name="apPat" class="form-control" id="inputApPat" placeholder="Apellido paterno">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputApMat" class="col-sm-3 control-label">Apellido Materno:</label>
                            <div class="col-sm-9">
                                <input value="<?php echo $apMat; ?>" type="text" name="apMat" class="form-control" id="inputApMat" placeholder="Apellido materno">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputCorreo" class="col-sm-3 control-label">Correo:</label>
                            <div class="col-sm-9">
                                <input value="<?php echo $cor; ?>" type="email" name="correo" class="form-control" id="inputCorreo" placeholder="Correo Electrónico">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPasswd" class="col-sm-3 control-label">Contraseña:</label>
                            <div class="col-sm-9">
                                <input value="<?php echo $pass; ?>" type="password" name="passwd" class="form-control" id="inputPasswd" placeholder="Contraseña">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputTelefono" class="col-sm-3 control-label">Telefono:</label>
                            <div class="col-sm-9">
                                <input value="<?php echo $tel; ?>" type="tel" name="telefono" class="form-control" id="inputTelefono" placeholder="Telefono">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <a href="../pages/admin/usuarios.php"><button type="button" class="btn btn-danger">Cancelar</button></a>
