            ...
            <article class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                <section>
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        <li role="presentation" class="active"><a href="#">Flores<!--<span class="badge">3</span>--></a></li>
                        <ul>
                ...
                <section>
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p>Se muestran los datos de las flores, la operacion ver información es para ver
                                sus petalos, la flor en 2D.</p>
                        </div>

                        <!-- Table -->
                        <table id="tablaf" class="table display">
                            <thead>
                            <th>ID</th>
                            <th>Costo</th>
                            <th>Fecha</th>
